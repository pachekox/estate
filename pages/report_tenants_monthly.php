	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				...
				<h1 class="page-header"> Active Tenants - Monthly Reports <button id="btnPrint" class="btn btn-primary btn-lg pull-right" >
					Print this Table
				</button></h1>
				...
				<div class="col-lg-12 modifyMe"> 
					<div class="panel panel-default">
						<div class="panel-heading">
							Active Tenants - Monthly Reports
						</div>
						<!-- /.panel-heading -->  
									...
									<tbody>
										...
										foreach ($fetch as $key => $value) { ?>
											<tr>
												...
												<td><?php echo $value['stall_rate'];?></td>
											</tr> 
