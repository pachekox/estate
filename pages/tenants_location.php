	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				...
				<h1 class="page-header"> Tenant Location</h1>
			</div>
										...
										foreach ($fetch as $key => $value) { ?>
											<tr>
												...
												<td class = "center" style = "text-align:center;">
													<a href = "#editlocation<?php echo $value['tenant_id'];?>" data-toggle = "modal" class = "btn btn-primary btn-xs">Change Tenant Location</a>
												</td>                      
											</tr> 
											<?php include 'edit_tenant_location_modal.php'; ?>
