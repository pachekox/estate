...
if($count > 0){
	...
	$add5 = $conn->prepare("INSERT INTO change_location(date,tenant_id,previous_stall,current_stall,stall_rate1) VALUES (?,?,?,?,?)");
	$add5->execute(array($date,$id,$previous_stall,$stall_current,$stall_rate1));
}
