	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				...
				<h1 class="page-header"> Lease Payments Reports<button onclick="myFunction()" id="btnPrint" class="btn btn-primary btn-lg pull-right" >
					Print this Table
				</button></h1>
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<table width="100%" class="table table-striped table-bordered table-hover tab" id="dataTables-example">
									...
									<tfoot>
										<?php
										$sql = "SELECT *, SUM(payment) as ccount FROM payments
										...
										foreach ($fetch as $key => $value) { 
											...
											<tr>
												...
												<th style="border-right: none; border-left: none;"></th>
												<th style="border-right: none; border-left: none;"></th>
												<th style="border-left: none">Total Lease Payments : &#8369; <?php echo number_format($value['ccount'])?></th>
												<?php } ?>
											</tr>
										</tfoot>
										<tbody>
